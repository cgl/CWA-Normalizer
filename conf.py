...
ovv_fun_20_filtered_extended = lambda x,y,z: not (x in mydict20_filtered) if tools.isvalid(x) and not tools.isHashtag(x) and not tools.isMention(x) and tools.isURL(x) else False
